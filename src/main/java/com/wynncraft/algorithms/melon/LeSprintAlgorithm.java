...
@Information(name = "LeSprint Sprint", version = 1, authors = "Melon")
public final class LeSprintAlgorithm implements IAlgorithm<LeSprintPlayer> {
    ...
    private LeSprintPlayer lastPlayer;
    private LeSprintPlayer preparedPlayer;
    private LeSprintPlayer activePreparedPlayer;
    ...
    @Override
    public Result run(LeSprintPlayer player) {
    ...
    private void prepareLight(LeSprintPlayer player, List<IEquipment> equipment) {
    ...
    private void capturePrepared(LeSprintPlayer player) {
    ...
    private void setPlayerToCurrentState(LeSprintPlayer player) {
    ...
    private void applyBestResult(LeSprintPlayer player) {
        if (bestCount == 0) {
            player.reset();
            return;
        }
    ...
    private Result finish(LeSprintPlayer player, List<IEquipment> equipment) {
